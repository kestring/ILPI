...
public class DataConverter {
    ...
    public static int stringTypeToIntegerPhone(String fone) {
        String intFone = fone.replaceAll("(", "").replaceAll(" ", "").replaceAll(")", "").replaceAll("-", "");
        System.out.println("Telefone = " + intFone);
        return Integer.parseInt(intFone);
    }
